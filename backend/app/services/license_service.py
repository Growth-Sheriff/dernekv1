...
class LicenseServiceService:
    """
    LicenseService iş mantığı servisi
    """
...
# Singleton instance
def get_license_service_service(db: Session) -> LicenseServiceService:
    return LicenseServiceService(db)

...
class AidatServiceService:
    """
    AidatService iş mantığı servisi
    """
...
# Singleton instance
def get_aidat_service_service(db: Session) -> AidatServiceService:
    return AidatServiceService(db)

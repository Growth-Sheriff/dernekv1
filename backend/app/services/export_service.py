...
class ExportServiceService:
    """
    ExportService iş mantığı servisi
    """
...
# Singleton instance
def get_export_service_service(db: Session) -> ExportServiceService:
    return ExportServiceService(db)

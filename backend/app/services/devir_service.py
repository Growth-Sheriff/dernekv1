...
class DevirServiceService:
    """
    DevirService iş mantığı servisi
    """
...
# Singleton instance
def get_devir_service_service(db: Session) -> DevirServiceService:
    return DevirServiceService(db)
